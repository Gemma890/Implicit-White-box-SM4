...
def equivalent_SM4_encrypt(implicit_round_function, explicit_extin_anf, explicit_extout_anf):
    ws = CONST.WORD_SIZE
    rounds = 64
    assert len(implicit_round_function) == rounds
    ...
    def eval_round_function(v, round_index):
        ...
        list_outputs = []
        systems_in_round_i = [implicit_round_function[round_index]]
...
if __name__ == '__main__':
    ...
    implicit_round_functions, explicit_extin_anf, explicit_extout_anf = sage.all.load(input_file, compress=True)
    ...
    eval_wb = equivalent_SM4_encrypt(implicit_round_functions, explicit_extin_anf, explicit_extout_anf)
